                ...
                switch (surpBox.selectBox.getSelectedIndex()){
                    ...
                    case GiftAndTrap:
                       ...
                       if(a4 == 0){
                        ...
                        surprise = new GiftAndTrap(maxTime, a4, a5);
                        break;
                    case ScreenEffects:
                        ...
                        surprise = new ScreenEffects(maxTime, a6);
                        break;
                    case Transference:
                        ...
                        surprise = new Transference(maxTime, a7, a8);
                        break;
                    case FullFreezing:
                        surprise = new FullFreezing(maxTime);
                        break;
                    case HelpSurprise:
                        surprise = new HelpSurprise(maxTime);
                        break;
                    case Rotation:
                        ...
                        surprise = new Rotation(maxTime, a9, b1);
                        break;
                }
                list4.add(surprise);
